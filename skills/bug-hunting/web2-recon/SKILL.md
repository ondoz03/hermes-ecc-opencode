...
### Minutes 0-5: Read Program Page + Scope Data

```jsonc
// From bounty-targets-data (Bugcrowd/HackerOne):
// curl -s https://raw.githubusercontent.com/arkadiyt/bounty-targets-data/main/data/bugcrowd_data.json
{
  "max_payout": 10000,
  "safe_harbor": "full",
  "targets": {
    "in_scope": ["*.indeed.com", "apis.indeed.com/graphql", "resume.com", "..."]
  }
}
```

See `references/bounty-scope-discovery.md` for full workflow — discover in-scope assets, sibling domains, API endpoints, and mobile apps before even registering an account.
